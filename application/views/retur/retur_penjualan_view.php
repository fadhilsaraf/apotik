        ...
        <div class="w3-container">
            <center>
              <h1 style="font-size:20pt">Retur Penjualan</h1>
            </center>
            <button class="btn btn-success" onclick="tambah_retur()"><i class="glyphicon glyphicon-plus"></i> Tambah Retur Penjualan</button>
            <br />
            <br />
            <br />
            <center>
...
$(document).ready(
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('retur/mengambilReturPenjualan')?>",
            "type": "POST"
        },
...
function tambah_retur()
{
    ...
    $('.modal-title').text('Tambah Retur Penjualan'); // Set Title to Bootstrap modal title
...
function simpan()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('retur/tambahReturPenjualan')?>";
    }
