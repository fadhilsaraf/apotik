        ...
        <div class="w3-container">
            <center>
              <h1 style="font-size:20pt">Transaksi Konsinyasi</h1>
            </center>
            <br />
            <br />
            <br />
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('transaksi/mengambilTransaksiKonsinyasi')?>",
            "type": "POST"
        },
...
function setujui_transaksi(id, setujui){
  ...
  function detail_transaksi(id){
    ...
    $('#detail > tbody').html('');
    $.getJSON("<?php echo site_url('transaksi/detailTransaksiKonsinyasi')?>/"+id,
        function (data) {
            console.log(data);
            $.each(data, function (key, value) {           
            $('#detail > tbody').append("<tr><td>"+value.nama_produk+"</td><td>"+value.nama_distributor+"</td><td>"+value.jumlah+"</td></tr>");
        })
    })
    ...
    $('.modal-title').text('Detail Konsinyasi'); // Set Title to Bootstrap modal title
